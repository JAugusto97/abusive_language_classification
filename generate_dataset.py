    ...
    with gzip.open(file) as f:
        ...
        for line in file_lines:
            ...
            try:  # Retweet
                ...
                # urls
                tweet_urls = []
                parsed_urls = parsed_line["retweeted_status"]["extended_tweet"][
                    "entities"
                ]["urls"]
                ...
                # mentions
                tweet_mentions = []
                parsed_mentions = parsed_line["retweeted_status"]["extended_tweet"][
                    "entities"
                ]["user_mentions"]
                ...
                # hashtags
                tweet_hashtags = []
                parsed_hashtags = parsed_line["retweeted_status"]["extended_tweet"][
                    "entities"
                ]["hashtags"]
                ...
                try:
                    ...
                    # mentions
                    tweet_mentions = []
                    parsed_mentions = parsed_line["extended_tweet"]["entities"][
                        "user_mentions"
                    ]
                    for parsed_mention in parsed_mentions:
                        if parsed_mention:
                    ...
                    # hashtags
                    tweet_hashtags = []
                    parsed_hashtags = parsed_line["extended_tweet"]["entities"][
                        "hashtags"
                    ]
                    for parsed_hashtag in parsed_hashtags:
                        if parsed_hashtag:
...
for row in data.itertuples():
    ...
    clean_tweet = [
        ...
        and not mentions_table.get(token)
        and not url_table.get("https:" + token)
        and not hashtag_table.get(token)
    ]
