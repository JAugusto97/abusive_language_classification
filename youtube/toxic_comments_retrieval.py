...
corpus = pd.DataFrame(columns=['comentario','toxico','homofobico',
                               'obsceno','insulto','racismo',
                               'misogino','xenofobia'])
#corpus = pd.read_csv(PATH_CORPUS, engine='python',
#                     names=['comentario','toxico','homofobico',
#                            'obsceno','insulto','racismo',
#                            'misoginia', 'xenofobia'])
